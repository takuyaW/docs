...
This is a sample Monaca app used to log into and log out of Facebook using [Graph API](https://developers.facebook.com/docs/reference/api/).

*Tested Environments:* Android 6.2, iOS 9.3.5

{{<figure src="/images/sampleapp/facebook/5.png">}}

{{<figure src="/images/sampleapp/facebook/7.png">}}

{{<download href="/download/facebook.zip" title="Click here to download project">}}
...
8.  Click on Settings and input your app domains and site URL. Then,
    ...
    here.
    {{<figure src="/images/sampleapp/facebook/10.png">}}

## File Components

{{<figure src="/images/sampleapp/facebook/8.png">}}
...
{{<figure src="/images/sampleapp/facebook/5.png" title="Startup Page">}}
...
{{<figure src="/images/sampleapp/facebook/7.png" title="Friend List">}}

## JavaScript Explanation

In order to log into Facebook, we are using [Graph API](https://developers.facebook.com/docs/reference/api/) and [InAppBrowser plugin](/en/reference/cordova_6.5/inappbrowser). The Graph API is the primary way for apps to read and write to the Facebook social graph. We use InAppBrowser to open a Facebook authentication page inside the app without opening of an external browser.

{{<figure src="/images/sampleapp/facebook/6.png" title="Facebook Login using InAppBrowser">}}
