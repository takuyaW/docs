...
#### <a name="checkupdate-api"></a> /checkUpdate
...
#### <a name="getserverversion"></a> getServerVersion()
...
#### <a name="forcestopdownload"></a> forceStopDownload()
...
## <a name="inapp-update-5-2-and-lower"></a> For Cordova 5.2 or Lower Projects
