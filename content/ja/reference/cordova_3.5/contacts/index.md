...
このドキュメントは [Adobe
Cordovaのドキュメント](https://github.com/apache/cordova-plugin-contacts/blob/master/doc/ja/index.md)
を翻訳したものになります。

</div>

このプラグインを使用して、デバイスの連絡先データベース ( contacts
database ) にアクセスできます。
