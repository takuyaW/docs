...
[iOS アプリのビルド]({{< ref "build_ios.md" >}}) をご確認ください。
...
[証明書の作成]({{< ref "build_ios.md#create-cer" >}}) と [プロビジョニング プロファイルの作成]({{< ref "build_ios.md#register-provisioning">}}) をご確認ください。

iOS 向けアプリのビルド方法、関連した証明書の発行手続などがわかりません。
------------------------------------------------------------------------

手順につきましては、[iOS アプリのビルド]({{< ref "build_ios.md" >}}) をご確認ください。
...
1.  [Monaca 提供のアップロード機能]({{<ref "app_submission.md">}}) を使用する場合 (
...
の秘密鍵や証明書を、外部へエクスポートできます。詳細は、[Monaca と Xcode 間でのビルド設定の再利用]({{<ref "import_export.md">}}) をご確認ください。
...
iOS の秘密鍵と証明書は、他のユーザーまたは環境で再利用できます。詳細は、[こちら]({{<ref "import_export.md">}})
をご確認ください。
...
Android
キーストアの作成方法とエクスポート方法は、[Android キーストアの設定]({{<ref "build_android.md#step-2-configure-android-keystore">}})
をご確認ください。
...
詳細は、 [ iOS の設定]({{< ref "ios_configuration.md" >}}) の `BackupWebStorage`
の項目をご確認ください。
