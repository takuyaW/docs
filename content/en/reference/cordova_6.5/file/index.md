...
(browser focused), see the HTML5 Rocks' [FileSystem
article.](http://www.html5rocks.com/en/tutorials/file/filesystem/) For
an overview of other storage options, refer to Cordova's [storage
...
-   Accessing the file system &lt;6.5\_persistent\_file&gt;
-   Using cross-platform Cordova file URLs to
    store your files &lt;6.5\_append\_file\_alternative&gt; (see Where
    to Store Files for more info)
-   Creating files &lt;6.5\_persistent\_file&gt; and
    directories &lt;6.5\_create\_directories&gt;
-   Writing to files &lt;6.5\_write\_file&gt;
-   Reading files &lt;6.5\_read\_file&gt;
-   Appending files &lt;6.5\_append\_file\_alternative&gt;
-   Display an image file &lt;6.5\_display\_image&gt;
